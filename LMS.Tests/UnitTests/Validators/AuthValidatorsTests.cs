...
public class AuthValidatorsTests
{
    [Fact] public void Login_Should_Fail_When_Email_Invalid()
    {
        ...
        new LoginCommandValidator().TestValidate(cmd).ShouldHaveValidationErrorFor(x => x.Email);
    }
    ...
    [Fact] public void Login_Should_Fail_When_Password_Too_Short()
    {
        ...
        new LoginCommandValidator().TestValidate(cmd).ShouldHaveValidationErrorFor(x => x.Password);
    }
